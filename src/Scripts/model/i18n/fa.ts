...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.cut]: "بریدن",
        [_.dataUsageLink]: "داده های شما چگونه استفاده می شود", 
        ...
        [_.daxFormatterAgreement]: "‫برای فرمت DAX، Bravo فرمول های شما را به سرویس DAX Formatter ارسال می‌کند.",
        ...
        [_.daxFormatterPreviewAllButton]: "نمایش همه فرمول ها",
        [_.daxFormatterPreviewButton]: "نمایش",
        [_.daxFormatterPreviewDesc]: "‫برای ایجاد پیش نمایش، Bravo باید این فرمول را به سرویس DAX Formatter ارسال کند.",
        [_.daxFormatterSuccessSceneMessage]: "‫تبریک می‌گویم, <strong>{count} فرمول{{ها}}</strong> با موفقیت فرمت شد.",
        [_.daxFormatterSummary]: `‫مجموعه داده شما شامل {count} فرمول می باشد: <span class="text-error"><strong>{errors:number}</strong> شامل خطا</strong></span>, <span class="text-highlight"><strong>{formattable:number}</strong> قابل فرمت</span>, <strong>{analyzable:number}</strong> برای آنالیز (<span class="link manual-analyze">آنالیز را انجام بده</span>).`,
        [_.daxFormatterSummaryNoAnalysis]: `‫مجموعه داده شما شامل <strong>{count}</strong> فرمول می باشد: <span class="text-error"><strong>{errors:number}</strong> شامل خطا</strong></span> و <span class="text-highlight"><strong>{formattable:number}</strong> قابل فرمت.</span>`,
        ...
        [_.devCreateTemplateNotes]: "‫برای انتخاب پوشه ای که در آن پروژه کد ویژوال استودیو حاوی الگوی جدید ذخیره می شود، بر روی <strong>ایجاد</strong> کلیک کنید.",
        ...
        [_.devTemplatesEditTitle]: "‫ویرایش در Visual Studio Code",
	...
	[_.devTemplatesRemove]: "حذف",
        ...
        [_.devTemplatesVSCodeDownload]: "دانلود‫ Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "‫دانلود پسوند {extension}",
        [_.devTemplatesVSCodeMessage]: "<p>‫پروژه الگوی تاریخ اکنون با Visual Studio Code باز می شود و نیاز به کامپایل شدن <b>{extension}</b> دارد.</p><p>اگر روی سیستم شما موجود نیست، لطفاً آن را دانلود نمایید:</p>",
        [_.devTemplatesVSCodeTitle]: "‫باز کردن با Visual Studio Code",
        [_.dialogCancel]: "انصراف",
        [_.dialogContinue]: "ادامه",
        [_.dialogNeverShowAgain]: "این را دیگر نمایش نده",
        [_.dialogOK]: "OK",
        ...
        [_.errorCheckForUpdates]: "نمی توان برای به روز رسانی ها بررسی کرد - سرور قابل دسترسی نیست.",
        ...
        [_.errorReportConnectionUnsupportedAnalysisServicesCompatibilityMode]: "‫حالت سازگاری Power BI Desktop Analysis Services  روی Power BI تنظیم نشده است.",
        ...
        [_.errorTitle]: "اوه...",
        [_.errorTOMDatabaseDatabaseNotFound]: "دیتابیس در مجموعه وجود ندارد یا کاربر دسترسی ادمین به آن ندارد.",
        ...
        [_.failed]: "ناموفق",
        [_.filterMeasuresWithErrorsCtrlTitle]: "فقط نمایش فرمول های دارای خطا",
        [_.filterUnrefCtrlTitle]: "فقط نمایش ستون های ارجاع داده نشده",
        [_.formattingMeasures]: "در حال فرمت فرمول ها...",
        ...
        [_.manageDatesTimeIntelligenceTargetMeasuresAll]: "تمام فرمول ها",
        [_.manageDatesTimeIntelligenceTargetMeasuresChoose]: "فرمول را انتخاب کنید...",
        [_.manageDatesTimeIntelligenceTargetMeasuresDesc]: "‫فرمول مورد استفاده برای تولید توابع Time Intelligence را انتخاب کنید.",
        [_.manageDatesTimeIntelligenceTargetMeasuresName]: "فرمول های هدف",
        ...
        [_.optionFormattingIncludeTimeIntelligenceDescription]: "‫شامل فرمول های ایجاد شده به طور اتوماتیک توسط مدیریت تاریخ برای Time Intelligence.",
        ...
        [_.optionFormattingPreviewDescription]: "‫برای تولید پیش‌نمایش، فرمول ها را به‌طور خودکار به DAX Formatter ارسال کنید.",
